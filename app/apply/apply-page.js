...
const GrantApplicationPage = ({ categories, approvalCriteria }) => {
        ...
        >
          ...
          <fieldset className="mb-8">
            <label>
              ...
              />
              <div className="w-full aspect-video rounded-md border-4 border-dashed cursor-pointer flex justify-center items-center">
                {selectedImage ? (
                  <div>
                    <img
